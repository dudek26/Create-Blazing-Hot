...
public class BlazingItems {
    ...
    public static final ItemEntry<Item> STELLAR_GOLDEN_APPLE = new FoodItemBuilder<>("stellar_golden_apple", Item::new)
            .alwaysEat()
            .nutrition(4)
            .saturationMod(1.1f)
            ...
            .rarity(Rarity.RARE)
            .fireResistant()
            .register(), IRON_CARROT = new FoodItemBuilder<>("iron_carrot", Item::new)
            .nutrition(5)
            .saturationMod(0.8f)
