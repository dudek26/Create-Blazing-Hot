...
public class BlazingCrushingRecipeGen extends BlazingProcessingRecipeGen {
    ...
    GeneratedRecipe STONE = create("stone", b -> b.require(Blocks.STONE).output(BlazingItems.STONE_DUST, 2).output(0.6F,
            BlazingItems.STONE_DUST).output(0.4F, BlazingItems.STONE_DUST).duration(250)), SOUL_SAND = create(
            "soul_sand",
            b -> b
                    ...
                    .duration(200)), BLAZE_GOLD_ROD = create("blaze_gold_rod",
