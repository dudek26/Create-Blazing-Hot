...
public class BlazeMixerRenderer extends KineticBlockEntityRenderer<BlazeMixerBlockEntity> {
	...
	@Override
	protected void renderSafe(BlazeMixerBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
		...
		SuperByteBuffer superBuffer = CachedBufferer.partial(BlazingPartialModels.SHAFTLESS_CRIMSON_COGWHEEL, blockState);
