...
public class BlazingSequencedAssemblyRecipeBuilder extends SequencedAssemblyRecipeBuilder {
	 ...
	 */
	public <T extends ProcessingRecipe<?>> BlazingSequencedAssemblyRecipeBuilder addMeltableStep(ProcessingRecipeBuilder.ProcessingRecipeFactory<T> factory, Function<BlazingProcessingRecipeBuilder<T>, ProcessingRecipeBuilder<T>> builder) {
		...
		self
				.getRecipe()
				.getSequence()
				.add(new BlazingSequencedRecipe<>(builder
						.apply((BlazingProcessingRecipeBuilder<T>) recipeBuilder
								.require(placeHolder)
								.output(placeHolder))
						.build(), true));
		return this;
