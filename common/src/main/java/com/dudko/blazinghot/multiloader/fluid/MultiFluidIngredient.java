...
public class MultiFluidIngredient {
	...
	public static FluidIngredient fromStack(FluidStack fluidStack) {
		return fromStack(new MultiFluidStack(fluidStack.getFluid(), MultiAmount.standard(fluidStack.getAmount())));
	}
