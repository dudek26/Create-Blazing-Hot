...
public class BlazingDeployingRecipeGen extends DeployingRecipeGen {

	public BlazingDeployingRecipeGen(PackOutput output, CompletableFuture<HolderLookup.Provider> registries, String defaultNamespace) {
